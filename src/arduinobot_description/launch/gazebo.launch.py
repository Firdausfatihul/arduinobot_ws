...
def generate_launch_description():
    ...
    model_arg = DeclareLaunchArgument(
        name="model",
        default_value=os.path.join(arduinobot_description, 
                                   "urdf", 
    ...
    # Add this to delete any existing arduinobot entity
    delete_entity = ExecuteProcess(
        cmd=['ros2', 'service', 'call', '/delete_entity', 'gazebo_msgs/DeleteEntity', '{"name": "arduinobot"}'],
        output='screen'
    )
